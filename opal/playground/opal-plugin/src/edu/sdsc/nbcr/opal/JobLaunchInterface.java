...
public interface JobLaunchInterface {
     ...
     */
    public String initJobLaunch(Properties props, OpalApplication app);//maybe this can just be the constructor of this class
     ...
     * @param inputFiles array of input file declared by the user when launching the job
     * 
     * @return the job ID
     */
    public String launchJob(String arglist, int numproc, String wd, String [] inputFiles, GSSCredential credential );
     ...
     * @return the job ID
     */
    public String launchJobBlocking(String arglist, int numproc, String wd, String [] inputFiles,  GSSCredential credential );
     ...
     * @return
     */
    public JobStatus queryStatus(String jobID,  GSSCredential credential);
    ...
    //public String[] getOutputs(String jobID);
     ...
     */
    //I think this method is useless
    //public FileInputStream getOutputByName(String jobID, String fileName);
     ...
     * @return
     */
    public JobStatus destroy(String jobID, GSSCredential credential);
