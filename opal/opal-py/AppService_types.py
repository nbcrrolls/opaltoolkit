...
class ns0:
    ...
    class GroupsType_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ...
            TClist = [ZSI.TC.AnyType(pname="id", aname="_id", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="name", aname="_name", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.AnyType(pname="elements", aname="_elements", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.Boolean(pname="required", aname="_required", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.Boolean(pname="exclusive", aname="_exclusive", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="semanticType", aname="_semanticType", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="textDesc", aname="_textDesc", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded"))]
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ZSI.TCcompound.ComplexType.__init__(self, None, TClist, pname=pname, inorder=0, **kw)
    ...
    class AppConfigType_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ...
            TClist = [GTD("http://nbcr.sdsc.edu/opal/types","AppMetadataType",lazy=False)(pname="metadata", aname="_metadata", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="binaryLocation", aname="_binaryLocation", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="defaultArgs", aname="_defaultArgs", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.Boolean(pname="validateArgs", aname="_validateArgs", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="jobManagerFQCN", aname="_jobManagerFQCN", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="drmaaPE", aname="_drmaaPE", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="drmaaQueue", aname="_drmaaQueue", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.URI(pname="globusGatekeeper", aname="_globusGatekeeper", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.URI(pname="gridftpBase", aname="_gridftpBase", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.Boolean(pname="parallel", aname="_parallel", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="metaServiceConfig", aname="_metaServiceConfig", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded"))]
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ZSI.TCcompound.ComplexType.__init__(self, None, TClist, pname=pname, inorder=0, **kw)
            class Holder:
                ...
                def __init__(self):
                    ...
                    self._drmaaPE = None
                    self._drmaaQueue = None
                    self._globusGatekeeper = None
                    self._gridftpBase = None
                    self._parallel = None
                    self._metaServiceConfig = None
                    return
            Holder.__name__ = "AppConfigType_Holder"
            self.pyclass = Holder

    class SystemInfoInputType_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        schema = "http://nbcr.sdsc.edu/opal/types"
        type = (schema, "SystemInfoInputType")
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ns = ns0.SystemInfoInputType_Def.schema
            TClist = []
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ...
            class Holder:
                ...
                def __init__(self):
                    # pyclass
                    return
            Holder.__name__ = "SystemInfoInputType_Holder"
            self.pyclass = Holder

    class SystemInfoType_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        schema = "http://nbcr.sdsc.edu/opal/types"
        type = (schema, "SystemInfoType")
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ns = ns0.SystemInfoType_Def.schema
            TClist = [ZSI.TC.String(pname="jobManagerType", aname="_jobManagerType", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="dataLifetime", aname="_dataLifetime", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TCnumbers.Iint(pname="hardLimit", aname="_hardLimit", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TCnumbers.Iint(pname="numCpuTotal", aname="_numCpuTotal", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TCnumbers.Iint(pname="numCpuFree", aname="_numCpuFree", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TCnumbers.Iint(pname="numJobsRunning", aname="_numJobsRunning", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TCnumbers.Iint(pname="numJobsQueued", aname="_numJobsQueued", minOccurs=1, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded"))]
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ZSI.TCcompound.ComplexType.__init__(self, None, TClist, pname=pname, inorder=0, **kw)
            class Holder:
                ...
                def __init__(self):
                    # pyclass
                    self._jobManagerType = None
                    self._dataLifetime = None
                    self._hardLimit = None
                    self._numCpuTotal = None
                    self._numCpuFree = None
                    self._numJobsRunning = None
                    self._numJobsQueued = None
                    return
            Holder.__name__ = "SystemInfoType_Holder"
            self.pyclass = Holder
    ...
    class JobInputType_Def(ZSI.TCcompound.ComplexType, TypeDefinition):
        ...
        def __init__(self, pname, ofwhat=(), attributes=None, extend=False, restrict=False, **kw):
            ...
            TClist = [ZSI.TC.String(pname="argList", aname="_argList", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TCnumbers.Iint(pname="numProcs", aname="_numProcs", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="userEmail", aname="_userEmail", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.String(pname="password", aname="_password", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TCnumbers.InonNegativeInteger(pname="wallClockTime", aname="_wallClockTime", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), GTD("http://nbcr.sdsc.edu/opal/types","InputFileType",lazy=False)(pname="inputFile", aname="_inputFile", minOccurs=0, maxOccurs="unbounded", nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.Boolean(pname="extractInputs", aname="_extractInputs", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded")), ZSI.TC.Boolean(pname="sendNotification", aname="_sendNotification", minOccurs=0, maxOccurs=1, nillable=False, typed=False, encoded=kw.get("encoded"))]
            self.attribute_typecode_dict = attributes or {}
            if extend: TClist += ofwhat
            if restrict: TClist = ofwhat
            ZSI.TCcompound.ComplexType.__init__(self, None, TClist, pname=pname, inorder=0, **kw)
    ...
    class getSystemInfoInput_Dec(ElementDeclaration):
        literal = "getSystemInfoInput"
        schema = "http://nbcr.sdsc.edu/opal/types"
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = (u'http://nbcr.sdsc.edu/opal/types', u'getSystemInfoInput')
            kw["aname"] = "_getSystemInfoInput"
            if ns0.SystemInfoInputType_Def not in ns0.getSystemInfoInput_Dec.__bases__:
                bases = list(ns0.getSystemInfoInput_Dec.__bases__)
                bases.insert(0, ns0.SystemInfoInputType_Def)
                ns0.getSystemInfoInput_Dec.__bases__ = tuple(bases)

            ns0.SystemInfoInputType_Def.__init__(self, **kw)
            if self.pyclass is not None: self.pyclass.__name__ = "getSystemInfoInput_Dec_Holder"

    class getSystemInfoOutput_Dec(ElementDeclaration):
        literal = "getSystemInfoOutput"
        schema = "http://nbcr.sdsc.edu/opal/types"
        substitutionGroup = None
        def __init__(self, **kw):
            kw["pname"] = (u'http://nbcr.sdsc.edu/opal/types', u'getSystemInfoOutput')
            kw["aname"] = "_getSystemInfoOutput"
            if ns0.SystemInfoType_Def not in ns0.getSystemInfoOutput_Dec.__bases__:
                bases = list(ns0.getSystemInfoOutput_Dec.__bases__)
                bases.insert(0, ns0.SystemInfoType_Def)
                ns0.getSystemInfoOutput_Dec.__bases__ = tuple(bases)

            ns0.SystemInfoType_Def.__init__(self, **kw)
            if self.pyclass is not None: self.pyclass.__name__ = "getSystemInfoOutput_Dec_Holder"
