...
#changeME
db_new = pg.connect (dbname="opal2_db", user="opal_user", passwd="opal_passwd", host='localhost')
db_old = pg.connect (dbname="opal_db", user="opal_user", passwd="opal_passwd", host='localhost')
startoutputID=60
startoutfilesID=60
#end changeme
